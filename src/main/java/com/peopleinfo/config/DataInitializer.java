...
public class DataInitializer implements CommandLineRunner {
        ...
        private void initializeDemoData() {
                ...
                User hr = userRepository.save(User.builder()
                                ...
                                .salary(85000.0)
                                .address("123,Anna Street,Gudiyattam,Tamil Nadu,632602")
                ...
                userRepository.save(User.builder()
                                ...
                                .email("sanjay.kumar@peopleinfo.com")
                                ...
                                .salary(95000.0)
                                .address("46A AK Road,Bangalore,Karnataka,560001")
                                .status(User.EmploymentStatus.ACTIVE)
                                .build());

                userRepository.save(User.builder()
                                .firstName("Sruthi").lastName("R")
                                ...
                                .salary(72000.0)
                                .address("789 Gandhi Nagar,Vellore,Tamil Nadu,632005")
                                .status(User.EmploymentStatus.ACTIVE)
                                .build());

                userRepository.save(User.builder()
                                .firstName("Deepak").lastName("S")
                                .email("deepak.s@peopleinfo.com")
                                .password(passwordEncoder.encode("emp123"))
                                .role(User.Role.EMPLOYEE)
                                .employeeId("EMP004")
                                .department("Finance")
                                ...
                                .salary(80000.0)
                                .address("321 GPM Street,Trichy,Tamil Nadu,620005")
                                .status(User.EmploymentStatus.ACTIVE)
                                .build());
                ...
                hiringRepository.save(HiringRequirement.builder()
                                ...
                                .responsibilities(
                                                "Assist in data pipeline development\nRun experiments\nPrepare reports\nCollaborate with senior team")
                ...
                log.info("Employee Login: sanjay.kumar@peopleinfo.com / emp123");
                log.info("==========================================");
        }
}
